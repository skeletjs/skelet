...
function final (instance, fn) {
  if (!(instance instanceof Object)) throw new TypeError('instance must be an instance of object')
  ...
  Object.defineProperty(instance, fn.name, {
    ...
    set: () => { throw new Error(`You are not allowed to reassign ${instance.constructor.name}.${fn.name}`) },
    configurable: false
  })
}
